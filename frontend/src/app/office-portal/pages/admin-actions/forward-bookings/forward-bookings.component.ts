...
@Component({
  selector: 'app-forward-bookings',
  templateUrl: './forward-bookings.component.html',
  styleUrls: ['./forward-bookings.component.css', '../../../shared/admin-forms.css'],
})
export class ForwardBookingsComponent implements OnInit, OnDestroy {
  rows: BookingRecord[] = [];
  ...
  private refresh(): void {
    this.rows = this.data.getBookingsByStatus('forward');
  }
