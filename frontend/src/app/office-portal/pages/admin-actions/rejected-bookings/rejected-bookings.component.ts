...
@Component({
  ...
  styleUrls: ['./rejected-bookings.component.css', '../../../shared/admin-forms.css'],
})
export class RejectedBookingsComponent implements OnInit, OnDestroy {
  rows: BookingRecord[] = [];
  ...
  private refresh(): void {
    this.rows = this.data.getBookingsByStatus('rejected');
  }
